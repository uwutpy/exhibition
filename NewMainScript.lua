...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		res = game:HttpGet("https://raw.githubusercontent.com/uwutpy/exhibition/main/"..scripturl, true)
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/uwutpy/exhibition/main/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/uwutpy/exhibition/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
OnlineProfilesButton.MouseButton1Click:Connect(function()
	...
	if profilesloaded == false then
		...
		for i,v in pairs(grabdata("https://raw.githubusercontent.com/uwutpy/Profiles/main/Profiles/"..saveplaceid.."/profilelist.txt")) do 
			onlineprofiles[i] = v
		end
		for i2,v2 in pairs(onlineprofiles) do
			local profileurl = "https://raw.githubusercontent.com/uwutpy/Profiles/main/Profiles/"..saveplaceid.."/"..v2.OnlineProfileName
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if (not teleported) and (not shared.VapeIndependent) then
		teleported = true
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vape/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/uwutpy/exhibition/main/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
	...
	spawn(function()
		...
		if not shared.VapeSwitchServers then
			if blatantmode["Enabled"] then
				pcall(function()
					local frame = GuiLibrary["CreateNotification"]("Blatant Enabled", "Exhibition is now in Blatant Mode.", 5.5, "assets/WarningNotification.png")
